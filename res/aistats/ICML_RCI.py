...
def plot_subfigure(ax, RES_num, name):
    ...
    for method in RES_num.keys():
        ...
        if method in ["BALLET-ICI"]:
            _label = f"{method} (R+G)"
        elif method in ["DKBO-AE", "DKBO-AE-RCI"]:
            _label = f"{method} (G)"
...
RES_num[f"DKBO-AE-RCI"] = np.load("../icml/rci/Pure-DK-hdbob0-rci-R2-T100_L4-TI15.npy")
...
RES_num[f"DKBO-AE-RCI"] = np.load("../icml/rci/Pure-DK-eg1db0-rci-R5-T50_L4-TI10.npy")
...
RES_num[f"DKBO-AE-RCI"] = np.load("../icml/rci/Pure-DK-nanob0_hd-rci-R5-T100_L4-TI10.npy")
...
RES_num[f"DKBO-AE-RCI"] = np.load("../icml/rci/Pure-DK-rosettab0-rci-R5-T100_L4-TI10.npy")
...
RES_num[f"DKBO-AE-RCI"] = np.load("../icml/rci/Pure-DK-water_converterb0_hd-rci-R5-T100_L4-TI10.npy")
...
RES_num[f"DKBO-AE-RCI"] = np.load("../icml/rci/Pure-DK-gb1b0-rci-R5-T100_L4-TI10.npy")
...
plt.savefig("icml_rci_1.pdf", bbox_inches='tight')
plt.savefig("icml_rci_1.png", bbox_inches='tight')
plt.close()
# plt.show()