...
for batch_size in [1,2,4,5,10,20]:
    RES_num[f"DKBO-OLP-Batch-{batch_size}"] = np.load(f"OL-batched_nano-B{batch_size}-kmeans-y-ts-R10-P3-T200_I0_L2-TI10-USmax.npy")
...
# plt.show()
plt.savefig("SimpleRegret_nano_mf.png")