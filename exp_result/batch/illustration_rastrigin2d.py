...
for batch_size in [1,2,4]:
    RES_num[f"DKBO-OLP-Batch-{batch_size}"] = np.load(f"OL-batched_rastrigin-B{batch_size}-kmeans-y-ts-R10-P3-T200_I0_L2-TI10-USmax.npy")
...
# for method in ["dkbo",'DKBO-OLP-Batch-5']:
    ...
    print(f"{method} {RES_num[method][:-1].mean()}")
...
# plt.show()
plt.savefig("SimpleRegret_rastrgin.png")