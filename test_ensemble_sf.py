...
if __name__ == "__main__":
    ...
    cli_parser.add_argument("--ensemble_num", nargs='?', default=1, type=int, help="number of ensemble")
    ...
    ensemble_num = cli_args.ensemble_num
    ...
    pure_dkbo(x_tensor=scaled_input_tensor, y_tensor=train_output,  n_init=cli_args.init_num, n_repeat=cli_args.run_times, low_dim=low_dim, beta=cli_args.beta,
                    ...
                    exact_gp=cli_args.exact_gp, constrain_noise=cli_args.constrain_noise, ensemble_num=ensemble_num)
